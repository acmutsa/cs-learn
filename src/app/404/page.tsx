  ...
  return (
    ...
    <main>
        ...
        <div className="flex flex-col space-y-2">
            ...
            <p className="text-gray-500">Please try again or go back to our{" "}
            <Link href='/home' className="font-semibold text-blue-500 hover:underline">main page</Link>
            </p>
        </div>
        ...
        <div className="flex items-center justify-between gap-6 px-6 mt-8">
            ...
            <Button onClick={(e) => { e.preventDefault(); window.location.href=
                "/home";}} className="text-white rounded-md px-6 py-7"> go back to the main page</Button>
        </div>
    </main>
    </div>
  )
